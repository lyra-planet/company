...
const Footer = () => {
    return (
        <>
        <div className='bg-blue-500 w-full py-16 px-10 text-white border-b border-white border-opacity-40'>
        ...
        <div className='bg-blue-500 w-full p-4 flex flex-row text-white text-opacity-40 justify-between'>
            <div>
